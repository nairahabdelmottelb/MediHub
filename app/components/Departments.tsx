export default function Departments() {
  ...
  <section className="py-5 bg-white">
    <div className="container">
      <h2 className="text-center text-primary mb-5">Our Medical Facilities</h2>
          ...
          <div className="card facility-card h-100">
            ...
            <div className="card-body">
              ...
              <ul className="facility-features">
                <li>
                  <i className="fas fa-check-circle text-success me-2"></i>Rapid
                  Response Team
                </li>
                <li>
          ...
          <div className="card facility-card h-100">
            ...
            <div className="card-body">
              ...
              <ul className="facility-features">
                ...
                <li>
                  <i className="fas fa-check-circle text-success me-2"></i>Home
                  Delivery
                </li>
              </ul>
            </div>
          ...
          <div className="card facility-card h-100">
            ...
            <div className="card-body">
              ...
              <ul className="facility-features">
                ...
                <li>
                  <i className="fas fa-check-circle text-success me-2"></i>Pain
                  Management
                </li>
              </ul>
            </div>
